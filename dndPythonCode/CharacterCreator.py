...
def create_pc():
    ...
    my_player = Pc(selected_race, selected_class, sub_race_generator(selected_race),
                   sub_class_generator(selected_class), background(), alignment(),
                   new_strength(selected_race, str_roll), strength_mod(selected_race, str_roll),
                   new_dexterity(selected_class, dex_roll), dexterity_mod(selected_class, dex_roll),
                   new_wisdom(selected_race, wis_roll), wisdom_mod(selected_race, wis_roll),
                   new_intelligence(selected_race, int_roll), intelligence_mod(selected_race, int_roll),
                   new_constitution(selected_race, con_roll), constitution_mod(selected_race, con_roll),
                   new_charisma(selected_race, cha_roll), charisma_mod(selected_race, cha_roll))
